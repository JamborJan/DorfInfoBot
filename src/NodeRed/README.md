...
To update to a new nodered version you have to:
- Update `package.json file to new version (line 3 and 32)
- To create a custom image with the same version, update also the `azure-pipeline.yml` file line 36.
